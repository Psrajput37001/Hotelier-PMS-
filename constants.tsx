...
export const Icons = {
  ...
  Tenants: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18"/><path d="M3 7v1a3 3 0 0 0 6 0V7"/><path d="M9 7v1a3 3 0 0 0 6 0V7"/><path d="M15 7v1a3 3 0 0 0 6 0V7"/><path d="M19 21v-4a2 2 0 0 1 2-2h0"/><path d="M5 21v-4a2 2 0 0 0-2-2h0"/><path d="M9 21V11a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v10"/></svg>
  ),
  Rooms: () => (
